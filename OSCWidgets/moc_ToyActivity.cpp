...
struct qt_meta_stringdata_FadeActivity_t {
    QByteArrayData data[3];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FadeActivity_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FadeActivity_t qt_meta_stringdata_FadeActivity = {
    {
QT_MOC_LITERAL(0, 0, 12), // "FadeActivity"
QT_MOC_LITERAL(1, 13, 8), // "onUpdate"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "FadeActivity\0onUpdate\0"
};
...
const QMetaObject FadeActivity::staticMetaObject = {
    { &FadeButton::staticMetaObject, qt_meta_stringdata_FadeActivity.data,
      qt_meta_data_FadeActivity,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FadeActivity::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FadeActivity.stringdata0))
